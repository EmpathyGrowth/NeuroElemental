...
import { signInWithOAuth, signUp } from '@/lib/auth/supabase';
  ...
  const onSubmit = async (values: SignupFormValues) => {
    ...
    try {
      ...
      if (signUpError) {
        ...
        setSuccess(true);
        // Wait before redirecting - use router.replace for consistent behavior
      ...
      <Card className="w-full max-w-md mx-auto">
        <CardHeader>
          ...
          <CardDescription className="text-center">
            Welcome to NeuroElemental. Redirecting you to your dashboard...
          </CardDescription>
        </CardHeader>
      </Card>
    );
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Get started with your free NeuroElemental account
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
