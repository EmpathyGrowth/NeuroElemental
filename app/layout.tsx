...
import { KeyboardShortcutsDialog } from "@/components/global/keyboard-shortcuts-dialog";
import { Navigation } from "@/components/navigation";
import { SiteAnnouncements } from "@/components/site-announcements";
import { SkipToContent } from "@/components/skip-to-content";
import { ThemeCssProvider } from "@/components/theme-css-provider";
...
export const metadata: Metadata = {
  ...
  description:
    "The first personality framework designed for how neurodivergent brains actually work. Energy-based, neurodivergent-informed, practical and ethical.",
  keywords: [
    "neurodivergent",
  ...
  openGraph: {
    ...
    description:
      "The first personality framework designed for how neurodivergent brains actually work.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
