...
export default function AdminBlogPage() {
  const { data: posts, loading, execute } = useAsync<any[]>();
  ...
  const fetchPosts = () => execute(async () => {
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      logger.error('Error deleting post:', err as Error);
    }
  };
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      ...
      <div className="grid gap-4 md:grid-cols-4 mb-8">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{(posts?.length || 0) - publishedPosts}</div>
            <p className="text-xs text-muted-foreground">
              Not published
            </p>
          </CardContent>
