  ...
  const handleSendInvites = async () => {
    ...
    try {
      ...
      const successCount = data.results.filter(
        (r: InviteResult) => r.status === "success"
      ).length;
      const errorCount = data.results.filter(
        (r: InviteResult) => r.status === "error"
      ).length;
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            >
              ...
              {sending
                ? "Sending invitations..."
                : `Send ${emailList.length} invitation(s)`}
            </Button>
          </CardContent>
        </Card>
        ...
        {showResults && results.length > 0 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Summary of sent invitations</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
        ...
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-900">
          ...
          <CardContent className="text-sm text-blue-800 dark:text-blue-200 space-y-2">
            <ul className="list-disc list-inside space-y-1">
              <li>
                Each email address should be on a new line or separated by
                commas/semicolons
              </li>
