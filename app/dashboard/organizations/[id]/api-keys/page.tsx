...
import { Key, Copy, Trash2, AlertTriangle, CheckCircle2, ChevronDown, ChevronRight } from 'lucide-react'
...
const SCOPE_GROUPS: ScopeGroup[] = [
  {
    ...
    scopes: [
      { scope: 'credits:read', description: 'Read credit balance and transactions' },
...
export default function ApiKeysPage() {
  ...
  const handleRevokeKey = async (keyId: string) => {
    try {
      const res = await fetch(`/api/organizations/${organizationId}/api-keys/${keyId}`, {
        method: 'PATCH',
      })
        ...
        <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
          ...
          <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Create a new API key for programmatic access. Select the permissions this key should have.
              </DialogDescription>
            </DialogHeader>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-amber-700 mt-1">
                        Store this API key securely. Anyone with this key can access your organization's data within the granted scopes.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                      ...
                      <div key={group.category} className="border rounded-lg p-4">
                        ...
                        <div className="space-y-2">
                          {group.scopes.map((scopeItem) => (
                            <div key={scopeItem.scope} className="flex items-start gap-2">
                              <Checkbox
                                id={scopeItem.scope}
                                checked={selectedScopes.has(scopeItem.scope)}
                                onCheckedChange={() => toggleScope(scopeItem.scope)}
                              />
                              <div className="flex-1">
                                <Label
                ...
                <DialogFooter>
                  ...
                  <Button
                    ...
                    disabled={creating || !keyName.trim() || selectedScopes.size === 0}
                  >
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {keys.map((key) => {
            ...
            return (
              <Card key={key.id} className={!key.is_active || expired ? 'opacity-60' : ''}>
                <CardHeader>
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                This will immediately disable the API key. Any applications using this key will no longer be able to access your organization's data.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
