                ...
                {activities.map((activity) => (
                  ...
                  >
                    ...
                    <div className="flex-1 space-y-1">
                      <div
                        className={`font-medium ${getActivityColor(activity.action_type)}`}
                      >
          ...
          <CardContent className="pt-6">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1 text-sm text-blue-800 dark:text-blue-200">
                ...
                <p>
                  This audit trail records all actions performed within your
                  organization, including member changes, credit transactions,
                  and settings updates. Activities are retained for compliance
