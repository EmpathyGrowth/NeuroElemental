...
export default function InstructorEditCoursePage({ params }: { params: { id: string } }) {
  ...
  // Fetch course details using instructor API
  useEffect(() => {
    const fetchCourse = async () => {
      try {
        ...
        setIsPublished(courseData.status === 'published' || courseData.is_published || false);
      } catch (error) {
  ...
  // Save course details using instructor API
