...
export async function getAllPermissions(): Promise<Permission[]> {
  try {
    ...
    logger.error('Error in getAllPermissions', error instanceof Error ? error : undefined, { errorMsg: String(error) })
    return []
  }
}
...
export async function getOrganizationRoles(
  ...
  try {
    ...
    logger.error('Error in getOrganizationRoles', error instanceof Error ? error : undefined, { errorMsg: String(error) })
    return []
  }
}
...
export async function getOrganizationRole(
  ...
  try {
    ...
    logger.error('Error in getOrganizationRole', error instanceof Error ? error : undefined, { errorMsg: String(error) })
    return null
  }
}
...
export async function createOrganizationRole(
  ...
  try {
    ...
    const validCodes = validPermissions?.map((p: { code: string }) => p.code) || []
    ...
    logger.error('Error in createOrganizationRole', err, { errorMsg: err.message })
...
export async function updateOrganizationRole(
  ...
  try {
    ...
    const err = error instanceof Error ? error : new Error(String(error));
    logger.error('Error in updateOrganizationRole', err, { errorMsg: err.message })
    return { success: false, error: err.message }
  }
}
...
export async function deleteOrganizationRole(
  ...
  try {
    ...
    const err = error instanceof Error ? error : new Error(String(error));
    logger.error('Error in deleteOrganizationRole', err, { errorMsg: err.message })
    return { success: false, error: err.message }
  }
}
...
export async function getUserPermissions(
  ...
  try {
    ...
    // Note: get_user_permissions RPC may not be in generated types
    const { data, error } = await supabase.rpc('get_user_permissions' as never, {
      p_user_id: userId,
    ...
    logger.error('Error in getUserPermissions', error instanceof Error ? error : undefined, { errorMsg: String(error) })
    return []
  }
}
...
export async function userHasPermission(
  ...
  try {
    ...
    logger.error('Error in userHasPermission', error instanceof Error ? error : undefined, { errorMsg: String(error) })
    return false
  }
}
...
export async function assignRoleToUser(
  ...
  try {
    ...
    const err = error instanceof Error ? error : new Error(String(error));
    logger.error('Error in assignRoleToUser', err, { errorMsg: err.message })
    return { success: false, error: err.message }
  }
}
...
export async function getRoleAssignmentHistory(
  ...
  try {
    ...
    logger.error('Error in getRoleAssignmentHistory', error instanceof Error ? error : undefined, { errorMsg: String(error) })
    return { history: [], total: 0 }
  }
}
...
export async function getMembersCountByRole(
  ...
  try {
    ...
    logger.error('Error in getMembersCountByRole', error instanceof Error ? error : undefined, { errorMsg: String(error) })
    return {}
  }
}
